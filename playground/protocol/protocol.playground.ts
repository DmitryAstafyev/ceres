...
export namespace Events {
	export class Ping extends Events {
		...
		public static getSignature(): string { return Ping.__signature; }
		public static getProtocol(): any { return Protocol; }
		public __signature: string = Ping.__signature;
		public getSignature(): string { return this.__signature; }
		public getProtocol(): any { return Protocol; }
		public static parse(str: string | object): Protocol.TTypes | Error { return Protocol.parse(str, Ping); }
		public stringify(): Protocol.TStringifyOutput | Error { return Protocol.stringify(this, Ping); }
		public static instanceOf(target: any): boolean { return Protocol.isInstanceOf(Ping.__signature, target); }
	...
	export class TargetedPing extends Events {
		...
		public static getSignature(): string { return TargetedPing.__signature; }
		public static getProtocol(): any { return Protocol; }
		public __signature: string = TargetedPing.__signature;
		public getSignature(): string { return this.__signature; }
		public getProtocol(): any { return Protocol; }
		public static parse(str: string | object): Protocol.TTypes | Error { return Protocol.parse(str, TargetedPing); }
		public stringify(): Protocol.TStringifyOutput | Error { return Protocol.stringify(this, TargetedPing); }
		public static instanceOf(target: any): boolean { return Protocol.isInstanceOf(TargetedPing.__signature, target); }
		public timestamp: Date = new Date();
		public message?: string = "";
	...
	export class EventToServer extends Events {
		...
		public static getSignature(): string { return EventToServer.__signature; }
		public static getProtocol(): any { return Protocol; }
		public __signature: string = EventToServer.__signature;
		public getSignature(): string { return this.__signature; }
		public getProtocol(): any { return Protocol; }
		public static parse(str: string | object): Protocol.TTypes | Error { return Protocol.parse(str, EventToServer); }
		public stringify(): Protocol.TStringifyOutput | Error { return Protocol.stringify(this, EventToServer); }
		public static instanceOf(target: any): boolean { return Protocol.isInstanceOf(EventToServer.__signature, target); }
		public timestamp: Date = new Date();
		public message?: string = "";
	...
	export class EventFromServer extends Events {
		...
		public static getSignature(): string { return EventFromServer.__signature; }
		public static getProtocol(): any { return Protocol; }
		public __signature: string = EventFromServer.__signature;
		public getSignature(): string { return this.__signature; }
		public getProtocol(): any { return Protocol; }
		public static parse(str: string | object): Protocol.TTypes | Error { return Protocol.parse(str, EventFromServer); }
		public stringify(): Protocol.TStringifyOutput | Error { return Protocol.stringify(this, EventFromServer); }
		public static instanceOf(target: any): boolean { return Protocol.isInstanceOf(EventFromServer.__signature, target); }
		public timestamp: Date = new Date();
		public message?: string = "";
...
export namespace Requests {
	export class IsOnlineServer extends Requests {
		...
		public static getSignature(): string { return IsOnlineServer.__signature; }
		public static getProtocol(): any { return Protocol; }
		public __signature: string = IsOnlineServer.__signature;
		public getSignature(): string { return this.__signature; }
		public getProtocol(): any { return Protocol; }
		public static parse(str: string | object): Protocol.TTypes | Error { return Protocol.parse(str, IsOnlineServer); }
		public stringify(): Protocol.TStringifyOutput | Error { return Protocol.stringify(this, IsOnlineServer); }
		public static instanceOf(target: any): boolean { return Protocol.isInstanceOf(IsOnlineServer.__signature, target); }
	...
	export class IsOnlineClient extends Requests {
		...
		public static getSignature(): string { return IsOnlineClient.__signature; }
		public static getProtocol(): any { return Protocol; }
		public __signature: string = IsOnlineClient.__signature;
		public getSignature(): string { return this.__signature; }
		public getProtocol(): any { return Protocol; }
		public static parse(str: string | object): Protocol.TTypes | Error { return Protocol.parse(str, IsOnlineClient); }
		public stringify(): Protocol.TStringifyOutput | Error { return Protocol.stringify(this, IsOnlineClient); }
		public static instanceOf(target: any): boolean { return Protocol.isInstanceOf(IsOnlineClient.__signature, target); }
